...
class TwitterBot(webapp.RequestHandler):
    def get(self):
        twitter_id = "yourtwitterid" # Configuraton: Add your twitter username
        twitter_pwd = "yourtwitterpwd"   # Configuration: Add your twitter password
        auth = tweepy.BasicAuthHandler(twitter_id, twitter_pwd)
        bot = tweepy.API(auth)
        shortapi = bitly.Api(login='yourbitlyid', apikey='yourbitlykey')
